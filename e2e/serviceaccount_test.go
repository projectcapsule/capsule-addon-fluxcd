...
var _ = Describe("Creating a new ServiceAccount", func() {
	...
	Context("in the Tenant system Namespace", Ordered, func() {
		...
		Context("not set as owner of the Tenant", func() {
			BeforeEach(func() {
			...
			It("should do nothing", func() {
				...
				Expect(configSecret.Data).To(BeNil())
			})
		})
		Context("set as owner of the Tenant", func() {
			...
			When("does not have the annotation to enable the addon", func() {
				BeforeEach(func() {
					sa = &corev1.ServiceAccount{
						ObjectMeta: metav1.ObjectMeta{
							Name:      TenantOwnerSAName,
			...
			When("has the annotation to enable the addon", func() {
				...
				It("should not generate GlobalTenantResource with the kubeConfig Secret", func() {
					Eventually(func(g Gomega) {
